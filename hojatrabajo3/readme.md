# UVG HOja de trabajo 3 - Algoritmos y Estructuras de Datos

## Assigment descrition:

The assigment was to code the following sort algorithms:
...
Then using a profiler to catch the CPU computing for each of these algoritms store such values in a CSV, then use some data software to compare the CPU performace against the mathematical results that the algorithms should in theory last. All this can be found in Hoja_trabjo_3_result_and_graphs.pdf in root, note that for this R markdown was used, you can also check that file on root.
